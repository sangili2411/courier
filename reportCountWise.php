                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <section class="panel">
                                            <header class="panel-heading mb-5" style="text-align: center; font-size: 20px; color: #0c1211;">
                                                Count Report - Branch Wise
                                            </header>
...
<script>
    ...
    function showReport() {
        ...
        if (fromDate == undefined || fromDate == null || fromDate == "") {
            ...
            window.location.href = "reportCountWiseView.php?fromDate=" + fromDate + "&toDate=" + toDate;
        }
    };
</script>