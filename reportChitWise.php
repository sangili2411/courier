...
$sql = "SELECT * FROM v_chit_accounts_details WHERE GROUP_ID = $groupId AND CHIT_MONTH = '$chitMonth' ORDER BY MEMBER_NAME";
                            ...
                            <div class="card-body">
                                <div class="form-validation">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-2">
                                            <button type="button" class="btn btn-success pull-right m-t-p5" onclick="window.location.href='reportChitWiseHome.php'">
                                        ...
                                        <table id="data-table" class="table table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        <tr>
                                                            <td><?php echo $i++; ?></td>
                                                            <td class="<?php echo $row['BALANCE'] == 0 ? '' : 'backgroud-red'; ?>"><?php echo $row['MEMBER_NAME']; ?></td>
