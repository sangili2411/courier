                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-validation">
                                    ...
                                    <div class="form-group">
                                        <button type="button" class="btn btn-success m-45" onclick="showGroupDetails(this)">
...
<script>
    let showGroupDetails = function() {
        if ($("#group-select").val() != "") {
            window.location.href = "reportChitWise.php?groupId=" + $("#group-select").val() + "&month=" + $("#month-select").val();
        } else {
